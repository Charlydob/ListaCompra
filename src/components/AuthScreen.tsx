...
export function AuthScreen() {
  ...
  return <main className="auth-shell"><section className="auth-card">
    ...
    {!firebaseConfigured && <div className="config-warning"><strong>Falta configurar Firebase.</strong><br />Copia <code>.env.example</code> a <code>.env</code> y añade las credenciales de tu proyecto.</div>}
